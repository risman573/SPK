    ...
    <div class="row">
        <div class="container-fluid my-3 main-container">
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="content-color-primary page-title">Nilai Keputusan</h2>
                    <p class="content-color-secondary page-sub-title">Kelola decision matrix (nilai alternatif per kriteria)</p>
                </div>
                <div class="col-auto">
                    <?php if ($tambah == "1") {?>
                ...
                <div class="card-header">
                    <div class="media">
                        <div class="media-body">
                            <h4 class="content-color-primary mb-0">Daftar Nilai Keputusan</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="modal-content">
            <form id="form">
                ...
                <div class="modal-body">
                    <input type="hidden" class="md-input" id="id_nilai" name="id_nilai"/>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#dt_default').DataTable({
            ...
            ajax: {
                url: "<?=$base_url?>penilaian/ajax_list",
                async: false,
                type: "POST",
                data: function(d){
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?=$base_url?>penilaian/edit/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function hapus(id) {
        ...
        if (question) {
            $.ajax({
                url: "<?=$base_url?>penilaian/delete/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
